...
namespace Resume.Tests
{
    ...
    public class ProgramOptionsTests
    {
        ...
        {
            // Setup the input.
            string[] args = new string[1] { @"--version" };
        ...
        {
            // Setup the input.
            string inputPath = @"c:\temp\resume.json";
            string outputPath = @"c:\temp\output";
            string[] args = new string[2] { inputPath, outputPath };
        ...
        {
            // Setup the input.
            string[] args = new string[3] { @"arg1", @"arg2", @"arg3" };
